...
const en = {
  ...
  all: "All",
  envKeyHint: "Uses a server-side DEX key — no key entry needed.",
  pubAddrHint: "Public address query — no API key needed.",
  readOnlyWarn: "⚠️ Ensure your API key has READ-ONLY permission only — no trading / withdrawal access.",
...
const zh: Record<keyof typeof en, unknown> = {
  ...
  comingSoon: "即将支持",
  all: "全部",
  envKeyHint: "使用服务端环境变量中的 DEX key — 无需输入密钥。",
  pubAddrHint: "公开地址查询 — 无需 API key。",
  readOnlyWarn: "⚠️ 请确保你的 API key 只有只读权限，没有交易/提现功能。",
  accountName: "账户名称",
