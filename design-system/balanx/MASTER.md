...
**Color Notes:** Blue trust + green growth (fintech/crypto demo direction — replaced the original gold/purple after user feedback: *"主题偏黄色我不太喜欢"*). Platform brand colors live in `lib/platforms.ts` (Binance `#F0B90B`, OKX DEX `#0F9CF3`, etc.) and are NOT part of the global palette.
